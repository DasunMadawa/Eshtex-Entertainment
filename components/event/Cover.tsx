...
export default function Cover() {
    ...
    return (
        <div
            ...
            style={{ backgroundImage: 'url("/img/Manobhawa - 2025 Main Art Work (Artists) (1).png")' }}
        >
            {/* buy ticket button */}
            ...
            {/* event title */}
            <h1 className='absolute left-5 md:left-10 lg:left-16 bottom-3 md:bottom-6 lg:bottom-10 text-white text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold italic'>Manobhawa</h1>
        </div>
    )
}
