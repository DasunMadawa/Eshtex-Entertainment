...
const HeroSection = () => {
    return (
        <div className='relative bg-black w-full min-[1000px]:max-h-[945px] min-[1000px]:aspect-[16/9] max-[1000px]:max-h-[1000px] max-[1000px]:min-h-[600px] max-[1000px]:h-screen'>
            <Image
